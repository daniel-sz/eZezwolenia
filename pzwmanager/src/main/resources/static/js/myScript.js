    ...
    $('.card .btn').on('click', function (event) {
        ...
        jQuery.get(href, function (item) {
            ...
            if (item.price1day == null){
                ...
                $(btn1).attr('value', Number(item.price1day).toFixed(2))
                $(btn1).select()
            }
            ...
            if (item.price3days == null){
                ...
                $(btn3).attr('value', Number(item.price3days).toFixed(2))
            }
            ...
            if (item.price7days == null){
                ...
                $(btn7).attr('value', Number(item.price7days).toFixed(2))
            }
            ...
            if (item.price1year == null){
                ...
                $(btn365).attr('value', Number(item.price1year).toFixed(2))
            }
        })
